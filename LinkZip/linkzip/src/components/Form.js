...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "linkzip-1fa46.web.app/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "linkzip-1fa46.web.app/" + this.state.preferedAlias
        }
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">linkzip-1fa46.web.app/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
